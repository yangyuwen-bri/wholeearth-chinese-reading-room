...
1970 年春季号、1970 年秋季号、1971 年 1 月号、1971 年 3 月增刊和 1974 年 *Whole Earth Epilog*。1968 年秋季号与 1969 年春季号
...
| 1971 年 3 月《最后一期增刊》 | 132 页译稿，leaf 035 待补证，原文忠实性重新复核中 | 校订稿明确提示原书第 34 页不完整，正式全册验收仍阻断 |
| 1974 *Whole Earth Epilog* | 283 页 accepted、25 页待高清复核、14 页无需翻译 | 已公开，QA 状态继续保留 |

## 内容原则

对外名称统一为“中文阅读室”，不使用“中文精读室”或“中文精读本”。章节导读和阅读说明须明确标为编者添加，不得冒充原刊正文。
...
6. 正文中的 `##` 小标题不是译文结束标记；只有工作流元数据标题可以终止正文提取。
7. 文件齐全、accepted 标签及发布哈希一致，不能替代原文忠实性与正文导出完整性的分别核验。

回归测试：`python3 -m unittest discover -s reader-prototype/tests -v`。本期构建器另有独立正文边界检查，必须在写出 JSON 前通过。

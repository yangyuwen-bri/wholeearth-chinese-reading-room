...
This report is updated after each reviewed batch.
...
- `n0`, `n16`–`n21`, `n23`–`n47`: source packs are complete; full translations,
...
- Verified public range: 48 leaves (`n0`–`n47`).
- Verified physical mapping: public leaves map to physical leaves `1`–`48`;
  physical `0` and `49` are excluded color cards.
- Calibration set: `n0` cover/questionnaire, `n1` dense long-form excerpt,

...
This report is updated after each accepted batch.
...
- `n11`, `n56`, `n140`: full translation and independent high-resolution scan-backed review pending.
...
- `n82` accepted with the complete Expanded Cinema record/excerpt, every Radical Software review and television/body/video-duel passage, the full Blackwell's review/payment rules/television excerpt, and all Tibetan Book poem, introspection, One Mind and Great Liberation text; no media experiment, order field or religious passage was summarized.
...
- `n13` accepted with the complete telescope review/record, optical bench, five specifications and every pipe-mount label, all three Star Maker excerpts, and the full Nature and Man's Fate review plus ten independent passages and plant-evolution caption; historical social-biological claims are explicitly bounded.
...
- `n7` accepted with both complete publication records, every macrobiotic health/political paragraph, all body/history/spine labels, both mushroom entries and three names, and full cheetah selection/feeding passages; historical health risks are explicitly bounded.
...
- Dense multi-column contents/index pages (`n3`–`n4`) require high-resolution
  scan reconstruction; official OCR line order is evidence, not reading order.
- No leaf may enter `accepted` with a summary, grouped entries, omitted prices,
  addresses, stock numbers, captions, labels, or index entries.
- Calibration accepted: `n0`–`n2`, including the complete 174-entry subscriber
...
- `n92` accepted with both metalwork books, all order data, forge-welding and
  jewelry-teaching passages, exact necklace dimensions, processes, and captions.
- `n97` accepted with every weaving advertisement and supplier, full Nez Perce
  exhibit notice and source fragments, pattern counts, wool grades, and prices.
- `n126` accepted with both full book reviews, all hand-study material, the

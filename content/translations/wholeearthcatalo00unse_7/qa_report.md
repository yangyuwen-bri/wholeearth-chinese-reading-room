...
- Current orchestrator states: `accepted=31` (`leaf_000`–`leaf_030` rebuilt or
  scan-audited and independently re-reviewed), `self_checked=101` pending
...
`leaf_030`, the current gate blocks with 284 findings. These counts mix

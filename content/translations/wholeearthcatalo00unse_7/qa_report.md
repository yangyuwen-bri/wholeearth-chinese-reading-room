...
- Current orchestrator states: `accepted=25` (`leaf_000`–`leaf_024` rebuilt or
  scan-audited and independently re-reviewed), `self_checked=107` pending
...
`leaf_024`, the current gate blocks with 303 findings. These counts mix

...
- Current orchestrator states: `accepted=20` (`leaf_000`–`leaf_019` rebuilt or
  scan-audited and independently re-reviewed), `self_checked=112` pending
...
`leaf_019`, the current gate blocks with 317 findings. These counts mix

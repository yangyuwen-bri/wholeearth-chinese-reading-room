...
- Current orchestrator states: `accepted=67` (`leaf_000`–`leaf_066` rebuilt or
  scan-audited and independently re-reviewed), `self_checked=65` pending
...
`leaf_066`, the current gate blocks with 181 findings. These counts mix

...
- Current orchestrator states: `accepted=17` (`leaf_000`–`leaf_016` rebuilt or
  scan-audited and independently re-reviewed), `self_checked=115` pending
...
`leaf_016`, the current gate blocks with 327 findings. These counts mix

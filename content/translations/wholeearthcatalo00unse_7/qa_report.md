...
- Current orchestrator states: `accepted=61` (`leaf_000`–`leaf_060` rebuilt or
  scan-audited and independently re-reviewed), `self_checked=71` pending
...
`leaf_060`, the current gate blocks with 197 findings. These counts mix

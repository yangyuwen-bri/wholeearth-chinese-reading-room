...
- Current orchestrator states: `accepted=53` (`leaf_000`–`leaf_052` rebuilt or
  scan-audited and independently re-reviewed), `self_checked=79` pending
...
`leaf_052`, the current gate blocks with 219 findings. These counts mix

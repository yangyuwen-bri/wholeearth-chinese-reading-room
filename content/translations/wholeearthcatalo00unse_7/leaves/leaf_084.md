# Leaf 084 Translation

## Source Pack

- Issue ID: wholeearthcatalo00unse_7
- Access leaf: n84; canonical physical scan leaf: 85 (origFileName=0085.jpg, pageType=Normal, addToAccessFormats=true).
- Printed page: 83 (official scandata pageNumber; use this as the printed-page authority).
...
~~~text
auna
only book available on Saunas: what they are, the
|history, how to use and enjoy, and how to build one.
Although the construction details are not extensive, there
4s a list of about 20 Sauna manufacturers who will send you
free construction plans, in hopes that you'll buy a heating
device from them.
[Suggested by Stan Gould]
x
t
! 1@1
YOOQOQOQ00000000
The simplest form of the family sauna is a one-room hut built of logs,
with a large rudimentary stove upon which rocks are placed.... The
heat of the sauna is non-radiant: that is, it does not radiate directly
toward the bather but rather is absorbed in the stones which emit
the heat into the air. The indirect heat is gentle and constant.... The
...
because moisture is instantly absorbed by the wooden walls...
traditional sauna includes beating with leafy birch branches, washing,
and a plunge in a nearby lake or roll in the snow outside. Then
follows a necessary rest while the body cools down completely.
...
There are several different kinds of platform. In some, a series of
...
paneling disposes of this problem in wall construc-
...
3) rail for propping up feet; 4) platform; 5) headrest.
Massage
‘People rubbing people is always nice. People rubbing people
with skill is an order of magnitude nicer. The problem is
acquiring skill; there don’t seem to be books that really
enter the subject in a friendly way. Ida Rolf, | gather, teaches
good technique, but you can’t get her through the mail. So,
until something better is inspired, this is the best massage
book we‘ve seen, It’s medical, thorough’, somewhat
textbooky, but the illustrations are many and informative
and what they teach feels very good indeed.
MPH
Certain persons seem to possess a natural ability to
relax their hands and to move them rhythmically,
and they will learn the technique of massage more
readily than others. However, anyone who con-
scientiously spends sufficient time in practice will
learn contact and rhythm and acquire good technique.
a ee ae a TL eee ea eS mY RR MNT eee aoe
(a) The thumbs remain in the air, and the finger
tips [without breaking the contact they have main-
tained at the temples in (2), (3), (4), (5), and (6)]
~~~

## Context Notes

- Section placement: Community; official scandata labels the page as printed page 83. The canonical scan is 0085.jpg / physical leaf 85.
- Visible entry and anchor inventory (source-led, scan verification required): Sauna book/building material; community health/body-care entries and diagrams.
- OCR heading anchors (verbatim, not normalized): "YOOQOQOQ00000000"; "or WHOLE EARTH CATALOG"; "BUILDING A FINNISH SAUNA"; "MPH"
...
- `sauna`：桑拿浴／芬兰浴。
- `tongue-in-groove paneling`：企口墙板。
- `counter-sunk nail`：沉头钉。

## Final Translation

### 《桑拿：芬兰浴》

这是一本可得的桑拿专书，谈它是什么、历史、怎样使用和享受，以及怎样建造。施工细节虽不很多，却列出约二十家桑拿制造商；他们会免费寄施工图，希望你向他们买加热装置。［Stan Gould 推荐］

最简单的家庭桑拿是用原木建成的一间小屋，内置一座粗朴大炉，炉上放石头。桑拿热不是辐射热：它不直接照向沐浴者，而由石头吸收后散入空气，因此温和而恒定。石头烧至通红，理想温度 190–200 度；往石上泼水，但空气仍干，因为水分立即被木墙吸收。传统桑拿包括用带叶桦树枝拍打、洗浴，随后跳进附近湖中或在外面雪地滚一滚；然后必须休息，待身体完全冷却。出汗浴的需要出现在人们必须做格外沉重体力劳动的国家；重活之后须使四肢恢复柔软和力量，才可继续劳动。

平台有不同形式：有的是一组台阶，最上一级较宽，可坐可躺；另一些以木梯通向如廊台的平台，上面放凳和长椅。若可能，桑拿应朝西，因为人们通常傍晚、常在日落时入浴；落日光线流进房内，会带来强烈宁静，躺在平台上望向湖面，可预尝从热浴跳入凉水深处的愉悦。

《桑拿：芬兰浴》，1965 年，87 页，邮资已付 3.95 美元。Stephen Greene Press，120 Main Street, Brattleboro, Vt. 05301。

内墙与天花板常用窑干、未上漆的红杉，因其不收缩、不翘曲、导热差；雪松也很好，兼有红杉优点、气味怡人且不易因湿气染色。应使用热浸镀锌钉以避免锈斑；在热房中沐浴者可能触及之处，钉子应沉头。企口墙板可解决墙面的这一问题；长凳可从下方上螺丝。一个实用布局包括：小凳作踏步、台阶、搁脚栏杆、平台、头枕。

...
well designed, illustrated, and diagrammed. The wri ting is
excellent, the subject matter important and new. The book
is inexpensive. Altogether Eye and Brain /ets you see how
...
such delay upsets the skill, this could be a serious matter. {t was
found that a shortdelay (about 0-5 seconds) made movements jerky
and iff co-ordinated, so that drawing became almost impossible, and
...
$2.45
°
i Eye and Brain - The Psychol f Seei
; Eye reco e Psychology of Seeing
i 1966; 254 pp.
4 $2.45 Postpaid from:
...
- Section placement: Communications; official scandata labels the page as printed page 69. The canonical scan is 0071.jpg / physical leaf 71.
- Visible entry and anchor inventory (source-led, scan verification required): Eye and Brain; Physical Control of the Mind; psychology/perception excerpts.
...
我想不出还有哪一本书做得这样好：设计、插图与图解都很出色；文字优秀，主题重要而新鲜，价格又低。总之，《眼与脑》会让你看出大多数书有多粗糙。

Stratton 后来做过一些较少为人知、却同样有趣的实验。他制作一套装在背带上的镜子装置，把自己的身体在视觉上移置：它看起来横躺在自己面前，与眼睛等高。他连续戴了三天（约二十四小时的视觉经验），报告说：“我感觉自己在精神上离开了身体。当然那只是短暂印象，却多次出现，持续时很鲜明……但批判性的兴趣一出现，这种单纯状态便消失；我看见的动作伴随着一个幽灵般的旧视觉形象。”

为什么在暧昧情境中，知觉系统会如此积极地寻找替代解法？它拒绝固守多个可能答案中的任一个，似乎比整个大脑皮层更活跃、也更智识诚实——若看政治或宗教中非理性信念的顽固性，或许可以这样说。知觉系统的生物学重要性远早于计算性智力；负责思考的大脑皮层区域相对幼小，和负责视觉的古老纹状区相比更自以为是。

Held 发现，只有主动活动的小猫会发展出知觉；被动的动物实际上仍是盲的。因此他认为，主动触摸对知觉发展不可或缺。
